...
export class NighthawkValidators {
  static mobilePhoneNumber(control: AbstractControl): { mobilePhoneNumber: true } | null {
    return validator.isMobilePhone(control.value, "any", { strictMode: false }) ? null : { mobilePhoneNumber: true };
  }
  ...
  static isPositiveNumber(control: AbstractControl): { invalidDestination: true } | null {
